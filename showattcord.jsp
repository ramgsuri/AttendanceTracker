...
.style2 {
	...
	<script language="javascript" src="js/cordinator.js" >
        ...
        <div id="main">
            <div id="logo">
              ...
              <div id="navbar">
                    <ul>
                      ...
                      <li><layer name="kl" width="87" height="19" id="kl"><a  href="cordinator.jsp" class="two" id="back"  >Back</a></layer>
                      </li>
            ...
            <div id="main-inner">
			   ...
			   <p><span class="style3">Welcome</span> <strong>To ATTENDANCE TRACKER </strong>
			    <font size="-1" face="Georgia, Times New Roman, Times, serif" color="#990000"><b><br/><div align="center"><br/>SELECT MONTH TO VIEW ATTENDANCE OF</div><u>
<% out.println("&nbsp;&nbsp;"+yr); %>'S &nbsp;&nbsp;of &nbsp;&nbsp;  <% out.println("&nbsp;&nbsp;"+branch); %></u></b></font>
...
<div id="option">
					 ...
					 <br/> <br/><strong>
					   ...
					   <div align='center'><select onchange="return shdcord();"  name='asgname' style='border:groove 2pt black' id='mon' /><option selected='selected'>--SELECT--</option>
