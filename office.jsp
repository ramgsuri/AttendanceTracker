...
.style2 {
	...
	<script language="javascript" src="js/office.js" ></script>
...
<% out.println("&nbsp;&nbsp;"+name); %></b></font>
				...
				<div id="wrt">
                    ...
                    <p>You <font color="#990000">to manage the records of student and faculty by clicking in options given aside.</font></p>
                    <p>You have the facility to view, update Faculty , students and Subjects records . <font color="#990000">Office members also have facility to up load the new notices regarding the college cirricullam.</font> </p>
				   </div>
                    <p>&nbsp;</p></div> 
...
<div id="option">
                      ...
                      <p align="center"><strong><a href="" class="one style6"  onclick=" return btech();"> <center>B.TECH</center></a></strong></p>
					   <p align="center"><strong><a href=""  class="one style6" onclick="return hello();"> <center> B.PHARMA</center></a></strong></p> 
					   <p align="center"><strong><a href=""  class="one style6" onclick="return hello();"> <center>MCA </center></a></strong></p>
					   <p align="center"><strong><a href=""  class="one style6" onclick=" return hello();"><center>MBA</center></a></strong></p> 
					   <p align="center"><strong><a href=""  class="one style6" onclick=" return hello();"><center>BDS</center></a></strong></p> 
					   <p align="center"><strong><a href=""  class="one style6" id="office" onclick=" return CHGPASS(this.id);"><center>CHANGE PASSWORD</center></a></strong></p> 
