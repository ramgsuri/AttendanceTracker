...
ResultSet rs=stmt.executeQuery(query); %>
        ...
        <div id="main">
            ...
            <div id="main-inner">
			          ...
			          <div class="clear"></div>
					  <div align="center"><% out.println("<p><font color='#990000' size='3px'><b><u>THIRD YEAR&nbsp;&nbsp;FACULTY</u></b></font></p>"); %></div>
           <div align="center">
		   
			<table width='297' height="35" border='0' align='center' bordercolor='#990000' bgcolor='#D8D8DA'>
			<tr ><td><div align="center"><font color="#990000" size="3px"><b><u>NAME</u></b></font></div></td><td><div align="center"><font color="#990000" size="3px" ><b><u>ROLL NO</u></b></font></div></td></tr> </table>
			<br>
			<br>
			<br>
			<form action="-brijco2sp.jsp" method="get">
			<table width='297' height="35" border='0' align='center' bordercolor='#990000' bgcolor='#D8D8DA'>
...
//int ssn=rs.getInt(2);
out.println("<td><font color='#464646' size='2px'><div align='center'>"+roll+"</div></font></td>");
out.println("<td><input type=radio name=stu value="+roll);
out.println("</td></tr>"); 
                          }
 %><tr><td>
<align="middle"><input type=submit name=view style='border:groove 2pt black;background:darkred;color:wheat;font-weight:bold'>		
	</align></td></tr>		
			</table></form></div>
		   </div>
