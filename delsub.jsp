...
.style2 {
	...
	<script language="javascript" src="js/deletesub.js" >
            ...
            <div id="logo">
              ...
              <div id="navbar">
                    <ul>
                       ...
                       <li><layer name="kl" width="87" height="19" id="kl"><a  href="office.jsp" class="two" id="FACULTY" onclick=" return STUDENT();" >Back</a></layer></li>
...
String b=null;
System.out.println("----delsub.jsp->"+branch);
...
ResultSet rs=stmt.executeQuery(query); %>
			          ...
			          <div class="clear"></div>
					  <div align="center"><% out.println("<p><font color='#990000' size='3px'><b><u>REMOVE&nbsp;&nbsp;"+branch+"&nbsp;&nbsp;SUBJECTS</u></b></font></p>"); %></div>
           <div align="center">
		  <form name="delsub" action="deletesubject.jsp" method="post">
			<table width='340' height="35" border='0' align='center' bordercolor='#990000' bgcolor='#D8D8DA' cellpadding="3" cellspacing="5">
			<tr ><td><div align="center"><font color="#990000" size="3px"><b><u>SUBJECT NAME</u></b></font></div></td>&nbsp;&nbsp;<td><div align="center"><font color="#990000" size="3px"><b><u>SUBJECT CODE</u></b></font></div></td>&nbsp;&nbsp;<td><div align="center"><font color="#990000" size="3px" ><b><u>SUBJECT ID</u></b></font></div></td>&nbsp;&nbsp;<td><div align="center"><font color="#990000" size="3px"><b><u>SELECT</u></b></font></div></td></tr> 
			</br>
			</br>
			</br>
...
out.println("<tr id='select'><td><font color='#464646' size='2px'><div align='center'><strong>"+subname+"</strong></div></font></td>");
...
out.println("<td><font color='#464646' size='2px'><div align='center'><strong>"+subid+"</strong></div></font></td>");
out.println("<td><font color='#464646' size='2px'><div align='center'><input type='radio' name='dsub' value='"+subid+"' id='"+subid+"' onFocus='return DELETE(this.id);' ></div></font></td><tr/>");
}
 %>
