            ...
            <div id="logo">
              ...
              <div id="navbar">
                    <ul>
                       ...
                       <li><layer name="kl" width="87" height="19" id="kl"><a  href="faculty.jsp" class="two" id="FACULTY"  >Back</a></layer></li>
...
//System.out.println("------>VIEW ATT HOD--");
 
// out.println("--------");
  
  String subid=request.getParameter("fasubid");
 String sec=request.getParameter("fasection");
 String subname1=request.getParameter("fasubname");
 String subcode1=request.getParameter("fasubcode");
  System.out.println("-subject id--->"+subid);
  System.out.println("-section--->"+sec);
 String mon=request.getParameter("month");
  System.out.println("-subname--->"+subname1);
   System.out.println("-subcode--->"+subcode1);
 String ssn=session.getAttribute("username").toString();
 System.out.println("--month-->"+mon);
//String b=null;

String b=session.getAttribute("brh").toString();
//System.out.println("----facultyshwatt.jsp->"+branch);
...
char yrs1=sec.charAt(0);
System.out.println("-char-->"+yrs1);
String yrs= String.valueOf(yrs1);
