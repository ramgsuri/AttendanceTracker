        ...
        <div id="main">
            ...
            <div id="main-inner">
			   ...
			   <p><span class="style3">Welcome</span> <strong>To ATTENDANCE TRACKER </strong>
			    <font size="-1" face="Georgia, Times New Roman, Times, serif" color="#990000"><b><br/><div align="center"><br/>SELECT MONTH TO VIEW ATTENDANCE OF</div>
<% out.println("&nbsp;&nbsp;"+yr); %></b></font>
...
<div id="option">
					 ...
					 <br/> <br/><strong>
					   ...
					   <div align='center'><select onchange="return shd();"  name='asgname' style='border:groove 2pt black' id='mon' /><option selected='selected'>--SELECT--</option>
