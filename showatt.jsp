...
.style2 {
	...
	<script language="javascript" src="js/showatt.js" >
...
<% 
System.out.println("-------->SHOWATT.jsp---");
...
System.out.println("--CURRENT MONTH-->"+currt);
	  ...
	  %>
        ...
        <div id="main">
            ...
            <div id="main-inner">
                <div id="main-inner-left"> <div id="img"><img src="images/32.jpg"  width="350px" height="161" /></div>
...
<div id="option">
					 ...
					 <br/> <br/><strong>
					   ...
					   <div align='center'><select onchange="return show();"  name='asgname' style='border:groove 2pt black' id='mon' /><option selected='selected'>--SELECT--</option>
