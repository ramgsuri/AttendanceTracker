...
.style2 {
	...
	<script language="javascript" src="js/chgpass.js" ></script>
...
st=h+"&nbsp;YEAR &nbsp;"+h2;
	  ...
	  %>
        ...
        <div id="main">
            ...
            <div id="main-inner">
                <div id="main-inner-left"> <div id="img"><img src="images/el.jpg"  width="350px" height="161" /></div>
...
<% out.println("&nbsp;&nbsp;"+st); %></b></font></div>
				...
				<div id="wrt">
				<br/>
				<FORM ENCTYPE='multipart/form-data' method='POST' name='upload' id='up'>
 <div align='center'><span class='style1'> <u>UPLOAD NOTICES</u></span></div>&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<br/> <font size='-1'><table bgcolor='#D8D8DA' align='center' border='2' bordercolor='#990000'  width='370'><tr> <td><br/> &nbsp;&nbsp;<span class='style1'>DISPLAY NAME:</span>&nbsp;<input name="dis" type="text" id="display" style='border:groove 2pt black '  title='PLEASE FILL IN THE DISPLAY NAME ON SITE' onfocus='fld(this);' onBlur="return SETNAME();" value="" size="30"> 
 <br/><br/> <p align='left'><span class='style1'>&nbsp;&nbsp;&nbsp;FILE SELECT:</span>
          <INPUT TYPE='file' NAME='RootPath' id='file'  style='border:groove 2pt black '  onfocus='fld(this);'  title='PLEASE BROWSE THE FILE'></p><br/><br/></td></tr></table></font>
 
 <div align='left'>
 <br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <INPUT TYPE='submit' VALUE='UPLOAD' onClick="return UP(); "  style='border:groove 2pt black;background:darkred;color:wheat;font-weight:bold'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='button' value='CLOSE' id=''  onclick='return CLS1();' style='border:groove 2pt black;background:darkred;color:wheat;font-weight:bold'></div><div id='ch'></div>
...
<div id="option">
                      ...
                      <p ></p>
					   <p align="center"><strong><a href=""  class="one style6" onclick="return ATTCORD();"> <center> VIEW ATTENDANCE</center></a></strong></p> 
					   <p align="center"><strong><a href="cordi.jsp"  class="one style6" > <center>UPLOAD NOTICES </center></a></strong></p>
					   <p align="center"><strong><a href=""  class="one style6" onclick=" return hello();"><center>EXEMPT FINE</center></a></strong></p> 
