...
String query="SELECT NAMES,SSNNO FROM "+b+"FACULTY WHERE BRANCH='"+b+"'";
...
ResultSet rs=stmt.executeQuery(query); %>
        ...
        <div id="main">
           ...
           <div align="center">
			...
			<form name="viewfaculty" method="get">
			<table width='297' height="35" border='0' align='center' bordercolor='#990000' bgcolor='#D8D8DA'>
			  
			  <% while(rs.next())
{
String name=rs.getString(1);
out.println("<tr><td><font color='#464646' size='2px'><div align='center'><strong>"+name+"</strong></div></font></td>");
int ssn=rs.getInt(2);
out.println("<td><font color='#464646' size='2px'><div align='center'><strong>"+ssn+"</strong></div></font></td></tr>");
}
 %>
